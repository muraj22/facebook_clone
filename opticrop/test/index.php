...
<p class="code">http://news.sciencemag.org../crop/?src=http://news.sciencemag.org/assets/2010/06/15/sn-topic.jpg&cmd=opticrop2(300x300)</p>

<p>To use, just include the above url as the src attribute of an img tag.</p>
<p class="code">&lt;img src="http://news.sciencemag.org../crop/?src=http://news.sciencemag.org/assets/2010/06/15/sn-topic.jpg&cmd=opticrop2(300x300)"/&gt;</p>
...
foreach ($files as $file) {
    ...
    $imgstr .= "<img src=\"../magick.php?src=/opticrop/test/$file&cmd=opticrop2(300x300)\"/>\n";
    $imgstr .= "<div class=\"spacer\">&nbsp;</div>\n";

    $imgstr .= "<img src=\"../magick.php?src=/opticrop/test/$file&cmd=opticrop2(200x50)\"/>\n";
    $imgstr .= "<div class=\"spacer\">&nbsp;</div>\n";
    $imgstr .= "<img src=\"../magick.php?src=/opticrop/test/$file&cmd=opticrop2(170x40)\"/>\n";
    $imgstr .= "<div class=\"spacer\">&nbsp;</div>\n";
    $imgstr .= "<img src=\"../magick.php?src=/opticrop/test/$file&cmd=opticrop2(80x80)\"/>\n";
    $imgstr .= "<div class=\"spacer\">&nbsp;</div>\n";
    $imgstr .= "<img src=\"../magick.php?src=/opticrop/test/$file&cmd=opticrop2(60x60)\"/>\n";
    $imgstr .= "<div class=\"clear\">&nbsp;</div>\n";
