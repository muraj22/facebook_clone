...
define('CLIENTID', '00000000480CEC69');
define('CLIENTSECRET', 'M1PXMKpAYhGuj3Qqia0rh0OvP9ZAPt7S');

// Make sure this is identical to the redirect_uri parameter passed in WL.init() call.
define('CALLBACK', 'http://subsbook.com/oauth/microsoft_callback.php');
...
function sjrefreshToken($refreshToken)
{
...
function handleTokenResponse($token, $error = null)
{
    ...
    if (!empty($token))
    {
        ...
        {
            sjrefreshToken($token->{ REFRESHTOKEN });
        }
    }
