    ...
    protected function compute_ii($canvas, $image_width, $image_height ){
        ...
        for($i=1; $i<$ii_w; $i++ ){  
            ...
            for($j=1; $j<$ii_h; $j++ ){
                ...
                $ii[$ii_this] = $ii[$ii_above] + $mssum;
                $ii2[$ii_this] = $ii2[$ii_above] + $mssum2;
            }
        }
...
$target_path="autocomplete/test.jpg";

$image = new resizer(); $image->prepare($target_path,$target_path);  $image->resize(500,500);

$detector = new Face_Detector('detection.dat');
$detector->face_detect("autocomplete/test.jpg");
$detector->toJpeg();
