...
cascade = ( CvHaarClassifierCascade* )cvLoad( "/usr/local/share/OpenCV/haarcascades/haarcascade_frontalface_alt2.xml", 0, 0, 0 );
...
cvClearMemStorage( storage2 );
		...
		cascade2 = ( CvHaarClassifierCascade* )cvLoad( "/usr/local/share/OpenCV/haarcascades/haarcascade_profileface.xml", 0, 0, 0 );
