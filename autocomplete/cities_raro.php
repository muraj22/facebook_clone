...
$dq="(SELECT city,population,country,region FROM cities7 WHERE city LIKE '%" . $termgotten2 . "%' ORDER BY population DESC LIMIT 10) UNION (SELECT city,population,country,region FROM cities WHERE city LIKE '%" . $termgotten2 . "%' LIMIT 10)";
...
array_merge($return_arr,$return_arr2);
