...
CKEDITOR.lang['nb'] =
{
	...
	findAndReplace :
	{
		...
		matchCase			: 'Skill mellom store og små bokstjr',
	...
	scayt :
	{
		...
		optionsTab		: 'Valg',
		allCaps			: 'Ikke kontroller ord med kun store bokstjr',
		ignoreDomainNames : 'Ikke kontroller domenenavn',
		mixedCase		: 'Ikke kontroller ord med blandet små og store bokstjr',
