...
function chkPass(pwd) {
	...
	if (pwd) {
		...
		else if (nScore >= 20 && nScore < 40) { if((nNumber>0) && (pwd.length>7)){sComplexity="Medium";}else{sComplexity = "Weak";} }
		else if (nScore >= 40 && nScore < 60) { sComplexity = "Medium"; }
		else if (nScore >= 60 && nScore < 80) { if(nSymbol>0){sComplexity = "Strong";}else{sComplexity="Medium";} }
		else if (nScore >= 80 && nScore <= 100) { if(nSymbol>0){sComplexity = "Strong";}else{sComplexity="Medium";} }
		

	$("#pscore").val(sComplexity);
	}
	else {
