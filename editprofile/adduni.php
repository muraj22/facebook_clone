...
$c=mysql_num_rows($r);
if($c>0){
mysql_query("UPDATE workedu SET position='$position',cityc='$cityc',statec='$statec',countryc='$countryc',description='$description',yeare='$yeare',monthe='$monthe',daye='$daye',yearl='$yearl',monthl='$monthl',dayl='$dayl',currently='$currently',datetimep=UNIX_TIMESTAMP() WHERE sbid='$sbid'");
...
$r=mysql_query("SELECT * FROM lists WHERE institution='$place' AND id='$uid' AND type='education'");
$c=mysql_num_rows($r);
if($c==0){
