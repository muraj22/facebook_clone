...
class RestTest extends BaseTest {
  ...
  public function testCreateRequestUri() {
    ...
    $this->assertEquals("/plus/me", $value);
    ...
    $this->assertEquals("/plus?u=me", $value);
    ...
    $params['u']['value'] = '1';
    $value = $this->rest->createRequestUri($basePath, $restPath, $params);
    $this->assertEquals("/plus/true", $value);

    $params['u']['location'] = 'query';
    $value = $this->rest->createRequestUri($basePath, '/plus', $params);
    $this->assertEquals("/plus?u=true", $value);
    ...
    $params['u']['value'] = '@me/';
    $value = $this->rest->createRequestUri($basePath, '/plus', $params);
    $this->assertEquals("/plus?u=%40me%2F", $value);
  }
}
