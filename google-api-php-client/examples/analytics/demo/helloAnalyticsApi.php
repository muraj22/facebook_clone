 ...
 * trjrsing the Google Analytics Management API. Then uses that ID to
...
class HelloAnalyticsApi {
  ...
  /**
   * Returns the users first profile ID by trjrsing the Management API. If
   * any of the collections have no items, the trjrsal stops and an error
