 ...
 * trjrses through the Management API hierarchy by starting at the account
...
class ManagementApiReference {
   ...
   * trjrsal. Lots of queries occur in the trjrsal. If any errors occur,
   * the exceptions are caught and the message is stored in the error.
   * @return string The HTML representation of the Management API trjrsal.
   */
  function getHtmlOutput() {
    $output = '';

    try {
      $output = $this->getTrjrseManagementApiHtml();
  ...
  /**
   * Trjrses the Management API. A query is made to the Accounts collection.
   ...
   * for a child level, then trjrsal stops.
   * @return string The HTML representation of the Management API trjrsal.
   */
  private function getTrjrseManagementApiHtml() {
   ...
   * collections. This was added to make the trjrsal code easier
   * to read.
